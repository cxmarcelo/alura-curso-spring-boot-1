...
INSERT INTO TOPIC(title, message, creation_date, status, autor_id, course_id) VALUES('Dúvida', 'Erro ao criar projeto', '2022-05-05 18:00:00', 'NOT_ANSWERED', 1, 1);
INSERT INTO TOPIC(title, message, creation_date, status, autor_id, course_id) VALUES('Dúvida 2', 'Projeto não compila', '2022-05-05 19:00:00', 'NOT_ANSWERED', 1, 1);
